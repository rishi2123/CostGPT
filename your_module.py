...
def query_to_code_llm(query: str, columns: str):
    ...
    data_df[data_df['JobTitle'] == 'GENERAL MANAGER-METROPOLITAN TRANSIT AUTHORITY'][['EmployeeName', 'TotalPay']] and it should not be
    ...
    salaries_df.resample('M', on='UsageDate').sum() and it should not be like
    ```python
